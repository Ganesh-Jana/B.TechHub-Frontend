const BASE_URL = "https://b-techhub-backend-6.onrender.com/api";
...
export const api = {
  ...
  getMaterials: (subjectId) =>
    request("GET", `/materials?subjectId=${subjectId}`),

  // Syllabus
  getSyllabus: (subjectId) =>
    request("GET", `/syllabus?subjectId=${subjectId}`),
...
export const dummyData = {
  ...
  materials: [
    ...
    {
      id: 2,
      title: "Unit 2 - Arrays and Linked Lists",
      type: "PDF Notes",
      size: "3.1 MB",
      uploadedBy: "Prof. Sharma",
      date: "2024-01-20",
    ...
    {
      id: 4,
      title: "Unit 4 - Sorting Algorithms",
      type: "PDF Notes",
      size: "2.9 MB",
      uploadedBy: "Prof. Sharma",
      date: "2024-02-10",
    ...
    {
      id: 5,
      title: "Reference Book - CLRS Chapter 1-5",
      type: "Book Extract",
      size: "8.2 MB",
      uploadedBy: "Admin",
      date: "2024-01-10",
